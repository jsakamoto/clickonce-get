...
public class CertificateValidaterTest : IHttpClientFactory
{
    ...
    {
        var pubKey = File.ReadAllText(this.PathOf("id_rsa.pub"));
    ...
    {
        new CertificateValidater(this)
            .GetModuleFromX509CertificateFile(this.PathOf("id_rsa.cer"))
            .Is(PublicKeyModule);
    }
    ...
    {
        var sshPubKeyString = File.ReadAllText(this.PathOf("id_rsa.pub"));
        var pathOfCertFile = this.PathOf("id_rsa.cer");
    ...
    {
        var sshPubKeyString = File.ReadAllText(this.PathOf("id_rsa.pub"));
        var pathOfCertFile = this.PathOf("another.cer");
