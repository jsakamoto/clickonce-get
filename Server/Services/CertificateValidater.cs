...
public class CertificateValidater
{
    ...
    {
        var module1 = this.GetModuleFromX509CertificateFile(pathOfCertFile);
        var modules2 = this.GetModuleFromSSHPublicKeyString(sshPubKeyString);
    ...
    {
        var module1 = this.GetModuleFromX509CertificateFile(cert);
        var modules2 = this.GetModuleFromSSHPublicKeyString(sshPubKeyString);
        return modules2.Any(module2 => Enumerable.SequenceEqual(module1, module2));
    }
    ...
    public byte[] GetModuleFromX509CertificateFile(string pathOfCert)
    {
        ...
        return this.GetModuleFromX509CertificateFile(cert);
    }
